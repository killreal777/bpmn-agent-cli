...
import { deleteSafeXml } from '../../write/deleteSafe.js';
import type { ParsedArgs } from '../args.js';

export async function deleteSafeCommand(args: ParsedArgs): Promise<unknown> {
  if (!args.file) {
  ...
  if (replacementFlowId !== undefined && typeof replacementFlowId !== 'string') {
